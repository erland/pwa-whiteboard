...
export const BoardEditorPage: React.FC = () => {
  ...
  const sharedStrokeColor = getSharedProp(selectedObjects, 'strokeColor') as string | undefined;
  const sharedStrokeWidth = getSharedProp(selectedObjects, 'strokeWidth') as number | undefined;
  const sharedFillColor = getSharedProp(selectedObjects, 'fillColor') as string | undefined;
  const sharedFontSize = getSharedProp(selectedObjects, 'fontSize') as number | undefined;
  const sharedText = getSharedProp(selectedObjects, 'text') as string | undefined;
  const sharedTextColor = getSharedProp(selectedObjects, 'textColor') as string | undefined;
                    ...
                    <div className="panel-row">
                      <label className="field-label">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleUpdateObject(singleSelectedObject.id, {
